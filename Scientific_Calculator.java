...
class Scientific_Calculator extends JFrame {
    ...
    private Scientific_CalculatorOp op = new Scientific_CalculatorOp();
    ...
    public Scientific_Calculator() {
        ...
        this.pack();
        this.setTitle("Scientific_Calculator");
    ...
    public class Scientific_CalculatorOp {
        private int total;
        public Scientific_CalculatorOp() {
            total = 0;
        }
...
class SwingScientific_Calculator {
    public static void main(String[] args) {
        JFrame frame = new Scientific_Calculator();
